...
public class bmsService {
    ...
    public void loadConfig(String filePath) {
        try (BufferedReader reader = new BufferedReader(new FileReader(filePath))) {
            ...
            if (stationsStart < 0 || stationsEnd < 0) throw new IllegalStateException("Invalid JSON format");
            ...
            for (String stationStr : stationStrs) {
                ...
                for (String part : parts) {
                    ...
                    if (keyValue.length == 2) {
                        ...
                        else if ("latitude".equals(key)) latStr = value;
                        else if ("longitude".equals(key)) lonStr = value;
                        else if ("capacity".equals(key)) capacity = Integer.parseInt(value);
                    }
                }
    ...
    public void endTrip(String tripId, Station endStation) {
        ...
        if (trip == null) throw new IllegalStateException("Trip " + tripId + " not found");
    ...
    public void moveBike(String bikeId, Station fromStation, Station toStation, User user) throws IllegalAccessException {
        if (user.getRole() != Role.OPERATOR) throw new IllegalAccessException("User " + user.getUserId() + " is not an Operator");
    ...
    public StationReadModel getStationReadModel(String stationName) {
        ...
        if (station == null) throw new IllegalStateException("Station " + stationName + " not found");
    ...
    private Station getStationForBike(String bikeId) {
        for (Station station : stations.values()) {
            if (findBikeById(bikeId, station) != null) return station;
        }
        return null;
    }
}